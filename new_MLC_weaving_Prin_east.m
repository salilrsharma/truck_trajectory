...
false_id = [6, 9, 14, 23, 28, 30, 32, 41, 43, 47, 49];
Truck_lane_change_data=[];
removal_id = [15, 16, 25, 31, 35, 40, 50];
...
%         Truck_lane_change_data=[Truck_lane_change_data;l,lane_change_duration, lag_gap, speed_at_merge, merge_location];
   ...
   if ismember(k,false_id)
        if k==6
            lane_change_initiation = 4;
            lane_change_completion = 115;
        elseif k==9
            lane_change_initiation = 40;
            lane_change_completion = 142;
        elseif k==14
            lane_change_initiation = 10;
            lane_change_completion = 56;
        elseif k==23
            lane_change_initiation = 28;
            lane_change_completion = 129;
        elseif k==28
            lane_change_initiation = 253;
            lane_change_completion = 325;
        elseif k==30
            lane_change_initiation = 10;
            lane_change_completion = 135;
        elseif k==32
            lane_change_initiation = 5;
            lane_change_completion = 62;
        elseif k==41
            lane_change_initiation = 43;
            lane_change_completion = 128;
        elseif k==43
            lane_change_initiation = 5;
            lane_change_completion = 128;
        elseif k==47
            lane_change_initiation = 35;
            lane_change_completion = 110;
        else
