...
%         Truck_lane_change_data=[Truck_lane_change_data;l,lane_change_duration, lag_gap, speed_at_merge, merge_location];
    ...
    if ismember(k,false_id)
        if k==4
            lane_change_initiation = 71;
            lane_change_completion = 314;
        elseif k==17
            lane_change_initiation = 1;
            lane_change_completion = 86;
%         elseif k==28
%             lane_change_initiation = 37;
%             lane_change_completion = 120;
%         elseif k==42
